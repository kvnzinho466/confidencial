...
function rankedMsg(player, message) {
    ...
    if (stats[Ss.WIN] > 399) {
        announcement += "[🧙‍] - [" + simbolGoal + ": " + statsGoals + "]「ʟᴇɴᴅᴀ ᴅᴏ X3」 "
        chatColor = "0x48D1CC"
